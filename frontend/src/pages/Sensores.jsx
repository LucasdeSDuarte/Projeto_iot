  ...
  return (
    <DashboardLayout tipo="colaborador">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-zinc-800">Sensores</h1>
        <button
        ...
        <table className="min-w-full bg-white rounded-xl shadow-md">
          <thead className="bg-zinc-100 border-b">
            <tr>
              ...
              <th className="text-left py-3 px-4 text-sm font-semibold text-gray-600">Identificador</th>
              <th className="text-left py-3 px-4 text-sm font-semibold text-gray-600">Unidade</th>
              <th className="text-left py-3 px-4 text-sm font-semibold text-gray-600">Dispositivo</th>
          ...
          <tbody>
            {sensoresFiltrados.map((s) => (
              <tr key={s.id} className="border-b hover:bg-zinc-50">
                ...
                <td className="py-3 px-4 text-gray-600">{s.identificador}</td>
                <td className="py-3 px-4 text-gray-600">{s.unidade}</td>
                <td className="py-3 px-4 text-gray-600">{s.appliance?.nome}</td>
